  ...
  <script type="text/javascript">
    ...
    $.ajax({
      ...
      $(document).ready(function(){
        $("#l_sup_name").removeClass("hidden");
        $("#sup_name").removeClass("hidden");
      });
      $.ajax({
        type: "POST",
        url: "r_get_sp.php",
      ...
      <div class="container">
        <form class="" action="" method="post">
          ...
          <div class="section">
            ...
            <div class="form-group row">
              <label for="p_type" class="col-sm-2 col-form-label">Select Sales Partner:</label>
              <div class="col-sm-10">
                <select class="custom-select" name="s_name" id = 's_name'>
                  <option>Choose Sales Partner</option>
                </select>
              </div>
            </div>
            <div class="form-group row">
              <label for="p_name" class="col-sm-2 col-form-label">Sales Partner Name:</label>
              <div class="col-md-10">
                <input type="text" class="form-control" name = "sp_name" id="sp_name" placeholder="Sales Partner Name" readonly>
              </div>
            </div>
            <div class="form-group row">
              <label for="p_name" class="col-sm-2 col-form-label">Select Holiday Partner:</label>
              <div class="col-sm-10">
                <select class="custom-select" name="h_name" id = 'h_name'>
                  <option>Choose Holiday Partner</option>
                </select>
              </div>
            </div>
            <div class="form-group row">
              <label for="p_name" class="col-sm-2 col-form-label">Holiday Partner Name:</label>
              <div class="col-md-10">
                <input type="text" class="form-control" name = "hp_name" id="hp_name" placeholder="Holiday Partner Name" readonly>
              </div>
            </div>
            <div class="form-group row">
              <label for="sup_name" id  ='l_sup_name' class="col-sm-2 col-form-label hidden">Select Super Partner:</label>
              <div class="col-sm-10">
                <select class="custom-select hidden" name="sup_name" id = 'sup_name'>
                  <option>Choose Super Partner</option>
                </select>
              </div>
            </div>
            <div class="form-group row">
              <label for="super_name" id = 'l_s_name' class="col-sm-2 col-form-label hidden">Super Partner Name:</label>
              <div class="col-md-10">
                <input type="text" class="form-control hidden" name = "super_name" id="super_name" placeholder="Super Partner Name" readonly>
              </div>
            </div>
          </div>
          <div class="section">
