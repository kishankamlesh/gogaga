...
if(isset($_POST["submit"])){
  ...
  if($conn->query($sql_log_ins) == true){
    ...
    if($u_type == "salesmanager"){
      ...
      $sql_sm_ins = "INSERT INTO salesmanagers (sno,name,dob,disp_name,phone,email,uid,district,state,date_of_joining, area_manager_name,a_m_sno,h_p_sno) VALUES ('$sno','$f_name','$dob','$d_name','$c_num','$email','$userid','$dist','$state','$date','$am_name','$am_id', '$hp_id')";
