  ...
  if(isset($_POST["submit"])){
      ...
      if($ghrnno == 'newform'){
        $sql_ins = "INSERT INTO agent_form_data (c_type,p_type,form_filled_by,holi_partner_name,holi_partner_loc,sales_partner_name,
                      ...
                      sight_pref,budget,lead_status,b_emi_card,datesent,salesmanager)
                      VALUES ('$c_type','$pack_type','$name','$p_type','$part_name','$p_name','$p_loc','$c_fname','$c_lname','$c_phone','$c_ttc','$c_loc',
                      ...
                      '$sight_s_pref','$budget','$l_status','$b_emi','$datesent','$sno')";
          if($conn->query($sql_ins)){
            ...
            $sql ="UPDATE  agent_form_data
                    ...
                    holi_partner_loc = '".$p_loc."', sales_partner_name = '".$p_name."', cust_firstname = '".$c_fname."',
                    ...
                    lead_status = '".$lead_status."', b_emi_card = '".$b_emi."',salesmanager = '".$sno."' WHERE ref_num = '".$ghrnno."'
                          ";
